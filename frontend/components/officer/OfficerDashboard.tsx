    ...
    <div className="flex h-full flex-col gap-4 md:flex-row md:gap-6">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-y-auto rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6 dark:border-gray-800 dark:bg-gray-900">
        ...
        {selected ? (
            ...
            <>
              <div className="mb-6">
                <div className="flex items-center gap-2 text-sm font-medium text-red-600 dark:text-red-400">
                  ...
                  <span className="break-words">{selected.alert_id}</span>
                </div>
                ...
                <p className="mt-2 break-words text-xs text-gray-400 dark:text-gray-500">
                  Triggering transaction: {selected.transaction_id}
                </p>
              </div>

              <div className="mb-6">
                <h2 className="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-100">Recent Transactions</h2>
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                      {transactions.map((txn) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{txn.transaction_type}</td>
                          <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{txn.description}</td>
                          <td className="px-4 py-3 text-right font-medium whitespace-nowrap text-gray-900 dark:text-gray-100">
          ...
          <div className="flex h-full flex-col items-center justify-center py-10 text-gray-500 dark:text-gray-400">
            <Inbox className="mb-4 h-16 w-16 text-gray-300 dark:text-gray-600" />
