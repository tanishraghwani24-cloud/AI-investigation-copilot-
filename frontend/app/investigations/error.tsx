  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
      ...
      <div className="mt-6 flex flex-wrap gap-4 items-center justify-center">
        ...
        <Link
          href="/investigations"
          className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-800 dark:bg-surface-dark dark:text-gray-300 dark:hover:bg-gray-800/60"
        >
